...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex justify-between p-3 sticky top-0 bg-white">
        ...
        <div className="flex gap-3 items-center">
          <div
            ...
            className="h-[50px] w-[50px] rounded-full relative cursor-pointer bg-gray-300 hover:bg-gray-200 flex items-center justify-center z-50"
          >
          ...
          <div className="h-[50px] w-[50px] rounded-full  cursor-pointer bg-gray-300 hover:bg-gray-200 flex items-center justify-center ">
            <FaFacebookMessenger size={30} />
          </div>
          <div className="h-[50px] w-[50px] rounded-full  cursor-pointer bg-gray-300 hover:bg-gray-200 flex items-center justify-center ">
            <HiMiniBell size={30} />
          </div>
          <div  onClick={()=>setSetting(!setting)} className="relative group h-[50px] w-[50px] rounded-full cursor-pointer bg-gray-300 hover:bg-gray-200 flex items-center justify-center">
            <FaUser size={30} />
